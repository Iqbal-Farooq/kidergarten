...
import ContactImg from "../../assets/img/appointment.jpg"
          ...
          <div className="lg:mb-0 mb-10">
            <div className="group w-full h-full">
              <div className="relative h-full">
                ...
                />
                {/* <h1 className="font-manrope gradient-text text-4xl font-bold leading-10 absolute top-11 left-11">Contact us</h1> */}
                <div className="absolute bottom-0 w-full lg:p-11 p-5">
                  <div className="bg-white rounded-lg p-6 block">
                    <Link href="#" className="flex items-center mb-6">
                     ...
                     <h5 className="text-black text-base font-normal leading-6 ml-5">778-0987-5542</h5>
                    </Link>
                    <Link href="#" className="flex items-center mb-6">
                      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link href="#" className="flex items-center">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">187 Zaingair, Sopore, J&K 19219</h5>
                    </Link>
                  </div>
                </div>
              </div>
